...
public class TestIteration1 {
	...
	private static String BASEDIR = "C:\\Users\\amyyu\\Desktop";
    ...
    @Test
    public void testIteration1Constructor() {
    	Iteration1 test = new Iteration1(BASEDIR);
    }
    ...
    public void testNullArguments() {
    	...
    	Iteration1 temp = new Iteration1(null);
    }
    ...
    public void testTooManyArguments() {
    	...
    	System.setOut(new PrintStream(outContent));
    	try {
    		Iteration1.main(new String[]{BASEDIR, "String","Bleh"});
    	}
    	catch(Exception e) {
    	}
    ...
    public void testInvalidDirectory(){
    	...
    	try {
    		Iteration1.parseFilesInDir(notDir);
    	}
    	catch(Exception e) {
    	}
    }
    ...
    public void testDeclarationReferenceCount() {
    	...
    	String code= "public class aTest{ \n" 
    			+ "public class bTest{} \n"
    			+ "String e;";
    	Iteration1 temp = new Iteration1(BASEDIR);
    ...
    public void testUnzipJar() {
    	try {
    		Iteration1.unzipJar(BASEDIR, "jarName");
    	}
    	catch (Exception e) {
    	}
    }
